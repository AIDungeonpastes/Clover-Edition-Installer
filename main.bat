...
echo The setup for Clover Edition has completed successfully, to play the game open the Clover-Edition directory in your terminal of choice (CMD, Powershell, etc...) and type python (or python3) play.py
cmd /k