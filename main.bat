...
echo And now the last setup step is up to you, you need to torrent a model and place it in the models folder, more information here: https://github.com/cloveranon/Clover-Edition#models
cmd /k